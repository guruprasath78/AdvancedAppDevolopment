...
function Sitesettings() {
    ...
    <div className='site-settings-entire'>
        ...
        <br/> 
            ...
            Welcome to Gift Vibes,
                At Gift Vibes, we believe that every gift tells a story. Our passion for creating memorable, personalized gifts led us to establish a platform where you can turn ordinary moments into extraordinary memories. We are more than just a gift customization website; we are curators of joy, dedicated to transforming your heartfelt sentiments into tangible, one-of-a-kind treasures.
                Our Mission
        ...
        <br/>
            ...
            At Gift Vibes, we value communication and are here to assist you in any way possible. Whether you have questions about our products, need assistance with customization, or want to explore partnership opportunities, were just a message away.
            Customer Support
            ...
            Email: partnerships@giftvibes.com'/>
        </div>
        <br/>
        <button className='sitesetting-btn1'>Edit</button> 
        <button className='sitesetting-btn2'>Save Changes</button> 
