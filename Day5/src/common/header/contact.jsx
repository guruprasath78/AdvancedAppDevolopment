  ...
  return (
        <div className='contact-entire'>
            ...
            <div className='contact-right'>
                ...
                <p>At Gift Vibes, we value communication and are here to assist you in any way possible. Whether you have questions about our products, need assistance with customization, or want to explore partnership opportunities, we're just a message away.</p>
                ...
                <br/><br/><b>Email: support@giftvibes.com</b>
                </p> 
                ...
                <br/> <br/>
                <b>Email: partnerships@giftvibes.com</b></p>
                </div> 
            </div>
