        ...
        <div className="about-container">
            <div className='about-outer'>
                ...
                <div className='about-right'>
                    <h1>About Us</h1>
                    <p>
                        &emsp; Welcome to GiftVibes, your go-to destination for personalized and custom gifts! At GiftVibes, we believe that every gift should be as unique as the person receiving it.
                    </p>
                    <p><br/>
                    ...
                    <p className='thanks'><br/>
                        Thank you for choosing GiftVibes for your gift-giving needs. We look forward to being a part of your special moments and helping you create cherished memories.
                    </p>
                </div>
            </div>
        </div>
